...
/**
 * Provider implementation for BLS (Bern, Switzerland).
 */
public class BlsProvider extends AbstractHafasClientInterfaceProvider {
    private static final HttpUrl API_BASE = HttpUrl.parse("https://bls.hafas.de/");
    ...
    private static final String WEBAPP_CONFIG_URL = "https://bls.hafas.de/config/webapp.config.json";

    public BlsProvider() {
        this(DEFAULT_API_CLIENT, WEBAPP_CONFIG_URL);
    }

    public BlsProvider(final String apiAuthorization) {
        this(DEFAULT_API_CLIENT, apiAuthorization);
    }

    public BlsProvider(final String apiClient, final String apiAuthorization) {
        super(NetworkId.BLS, API_BASE, PRODUCTS_MAP);
        setApiEndpoint("gate");
        setApiVersion("1.68");
