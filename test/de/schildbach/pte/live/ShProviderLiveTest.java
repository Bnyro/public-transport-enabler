...
public class ShProviderLiveTest extends AbstractProviderLiveTest {
    ...
    public void nearbyStationsByCoordinate() throws Exception {
        final NearbyLocationsResult result = queryNearbyStations(LocationUtil.coord(54325845, 10122920));
        print(result);
    ...
    public void queryDepartures() throws Exception {
        final QueryDeparturesResult result = queryDepartures("8002547", NetworkProvider.EquivalentStationsMode.USE_META);
        print(result);
    }
