...
public class SaarVVProviderLiveTest extends AbstractProviderLiveTest {
    ...
    public void nearbyStationsByCoordinate() throws Exception {
        final NearbyLocationsResult result = queryNearbyStations(LocationUtil.coord(49234783, 6995687));
        print(result);
    }
    ...
    public void queryDepartures() throws Exception {
        final QueryDeparturesResult result = queryDepartures("8000244", NetworkProvider.EquivalentStationsMode.USE_META);
        print(result);
    }
