...
public class VvtProviderLiveTest extends AbstractProviderLiveTest {
    ...
    public void nearbyStationsByCoordinate() throws Exception {
        final NearbyLocationsResult result = queryNearbyStations(LocationUtil.coord(47271228, 11402063));
        print(result);
    }

    @Test
    public void queryDepartures() throws Exception {
        final QueryDeparturesResult result = queryDepartures("470118700", NetworkProvider.EquivalentStationsMode.USE_META);
        print(result);
    }
