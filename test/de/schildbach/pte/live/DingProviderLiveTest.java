...
public class DingProviderLiveTest extends AbstractProviderLiveTest {
    ...
    public void nearbyStationsByCoordinate() throws Exception {
        final NearbyLocationsResult result = queryNearbyStations(LocationUtil.coord(48401092, 9992037));
        print(result);
    }

    @Test
    public void queryDepartures() throws Exception {
        final QueryDeparturesResult result = queryDepartures("90001611", NetworkProvider.EquivalentStationsMode.USE_META);
        print(result);
    }
