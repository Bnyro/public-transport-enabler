...
public class LinzProviderLiveTest extends AbstractProviderLiveTest {
    ...
    public void nearbyStationsByCoordinate() throws Exception {
        final NearbyLocationsResult result = queryNearbyStations(LocationUtil.coord(48305726, 14287863));
        print(result);
    }

    @Test
    public void queryDepartures() throws Exception {
        final QueryDeparturesResult result = queryDepartures("60501720", NetworkProvider.EquivalentStationsMode.USE_META);
        print(result);
    }
