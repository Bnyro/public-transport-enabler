...
public class KvvProviderLiveTest extends AbstractProviderLiveTest {
    ...
    public void nearbyStationsByCoordinate() throws Exception {
        final NearbyLocationsResult result = queryNearbyStations(LocationUtil.coord(49008184, 8400736));
        print(result);
    }

    @Test
    public void queryDepartures() throws Exception {
        final QueryDeparturesResult result = queryDepartures("7000090", NetworkProvider.EquivalentStationsMode.USE_META);
        print(result);
    }

    @Test
    public void queryDeparturesMesseKarlsruhe() throws Exception {
        final QueryDeparturesResult result = queryDepartures("7000211", NetworkProvider.EquivalentStationsMode.USE_META);
        print(result);
    }
